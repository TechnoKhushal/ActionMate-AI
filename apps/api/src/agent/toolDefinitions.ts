...
export const toolDefinitions: ChatCompletionTool[] = [
  {
    ...
    function: {
      name: "find_contact",
      description:
        "Find a person's contact information by name. Use this before creating a meeting with a person.",
      parameters: {
        type: "object",
        properties: {
          name: {
  ...
  },
  {
    ...
    function: {
      name: "check_calendar",
      description:
        "Get calendar events between two ISO timestamps so you can determine availability.",
      parameters: {
        type: "object",
        properties: {
          timeMin: {
  ...
  function: {
    ...
    description:
      "Find the first genuinely free calendar slot in a requested time window. The application calculates availability from the real calendar.",
    parameters: {
      type: "object",
      properties: {
        date: {
...
},
  {
    ...
    function: {
      name: "create_meeting",
      description:
        "Create a calendar meeting with an attendee. Only use this after finding the contact and checking calendar availability.",
      parameters: {
        type: "object",
        properties: {
          title: {
